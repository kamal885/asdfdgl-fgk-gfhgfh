...
client.user.setGame(`#$aTààŅ , ÓuŤ `,"http://twitch.tv/S-F")
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
...
client.on("message", message => {
 if (message.content === '$play') {
  const embed = new Discord.RichEmbed()
      .setColor("#000000")
      .setDescription(`
1play ⇏ لتشغيل أغنية برابط أو بأسم
1skip ⇏ لتجاوز الأغنية الحالية
1pause ⇏ ايقاف الأغنية مؤقتا
1resume ⇏ لمواصلة الإغنية بعد ايقافها مؤقتا
1vol ⇏ لتغيير درجة الصوت 100 - 0
1stop ⇏ لإخرآج البوت من الروم
1np ⇏ لمعرفة الأغنية المشغلة حاليا
1queue ⇏ لمعرفة قائمة التشغيل
 `)
